  ...
  return (
    <>
      ...
      <div className={styles.square3Wrap}>
        ...
        <ParallaxLayer offset={0} speed={3.6}>
        ...
        <ParallaxLayer offset={0} speed={3}>
          <div className={styles.pic1}>
            <div className={styles.pic1Content}>
              ...
              <Image src="/images/me1.png" width={3024} height={3024} />
            </div>
          </div>
        </ParallaxLayer>
